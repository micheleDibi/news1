...
# ---------------------------------------------------------------------------
# v4: sezione 8 (TestValidatoreOutputAI) rimossa.
# Validava AiClassificationOutputValidator, deprecato col worker AI pre-skill.
# La validazione di output e' ora autoritativa skill-side (bandi-seo-enricher).
# ---------------------------------------------------------------------------
