...
const cancelContactForm = () => {
  ...
  const onSubmit = async (data: any, event?: React.BaseSyntheticEvent) => {
    ...
    try {
      ...
      // L'editor non offre modo di cambiare lo slug: si genera alla prima
      // scrittura e poi resta. Per cambiarlo di proposito serve una PUT con
      // l'header X-Slug-Intent, che l'interfaccia non invia mai.
              ...
              <div className="col-span-1 space-y-4 lg:space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="p-4 lg:p-5 space-y-4">
                    {/* Ortografia: ambiguita' che non si correggono da sole */}
