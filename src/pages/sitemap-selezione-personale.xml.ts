/**
 * Sitemap storica di selezione-personale, ora spezzata in blocchi da 1000 URL sotto
 * /sitemap-selezione-personale/N.xml ed elencata direttamente in /sitemap-index.xml.
 *
